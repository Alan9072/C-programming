...
int main() {
    ...
    while (op != 4) {
        ...
        switch (op) {
            case 1:
                printf("1.Insertion at beginning\t2.Insertion at End\t3.Insertion at any location\nEnter your choice: ");
                scanf("%d", &choice);
                if (choice == 1)
                    begin_insert();
                else if (choice == 2)
                ...
                break;
            case 2:
                printf("1.Delete from beginning\t2.Delete from end\t3.Delete from any location\nEnter your choice: ");
                scanf("%d", &choice);
                if (choice == 1)
                    begin_delete();
                else if (choice == 2)
